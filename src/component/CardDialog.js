  ...
  render () {
    ...
    return (
      <CustomDialog
        ...
        onClose={() => this.cardDialogClose()}>
        <div
          style={{ backgroundImage: `linear-gradient(315deg, ${this.getElementColor(card.bonusAbilityActiveElement)} 70%, rgba(255, 255, 255, 0.2) 100%)` }}
